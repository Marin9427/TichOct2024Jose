...
namespace IMSS
{
    public struct AportacionesEstructura
    {
        public AportacionesEstructura(decimal enfermedadMaternidad, decimal invalidezVida, decimal retiro, decimal cesantia, decimal infonavit)
        {
